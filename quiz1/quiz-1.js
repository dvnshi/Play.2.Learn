...
const quizArray = [
  {
    ...
    options: ["Going to school only on weekdays", "Going to school without homework", "Going to school for primary education", ],
  ...
  },
  {
    ...
    options: ["Only children from wealthy families", "Only boys",  "Every child, regardless of their background"],
  ...
  },
  {
    ...
    options: [ "Help them by telling a teacher or an adult you trust", "ignore them", "tease them"],
